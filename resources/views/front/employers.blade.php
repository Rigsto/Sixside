            ...
            <div class="row d-sm-flex d-md-flex d-lg-flex d-xl-flex justify-content-sm-center justify-content-md-center align-items-lg-center align-items-xl-center">
                <div class="col-sm-12 col-md-9 col-lg-6 col-xl-5 text-center text-sm-center text-md-center text-lg-left text-xl-left d-sm-flex order-2 order-sm-2 order-md-2 order-lg-1 order-xl-1">
                    <div>
                        ...
                        <div class="text-md-center d-flex flex-column flex-shrink-0 align-items-stretch align-content-center flex-sm-row justify-content-sm-center align-items-sm-center flex-md-row justify-content-md-center align-items-md-center flex-lg-row justify-content-lg-start align-items-lg-center flex-xl-row justify-content-xl-start align-items-xl-center"><button class="btn btn-primary border-white primaryBtnHovered" type="button" style="background-color: #ED5D56;font-family: Inter, sans-serif;font-weight: 500;padding-top: 8px;padding-bottom: 8px;">Request Employees</button>
                            <p class="visible"
                               style="margin-right: 20px;margin-left: 20px;max-height: 100%;min-height: 100%;margin-top: 16px;color: rgb(197,197,197);font-size: 12px;">OR</p><button class="btn btn-primary" type="button" style="background-color: rgb(255,255,255);color: rgb(0,0,0);font-family: Inter, sans-serif;font-weight: 500;padding-top: 8px;">Looking for a job?</button></div>
                    </div>
                </div>
